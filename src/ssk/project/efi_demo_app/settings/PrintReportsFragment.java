...
public class PrintReportsFragment extends Fragment {
    ...
    PrintReportsFragment(){
    }    
     
    public static PrintReportsFragment newInstance(){
        PrintReportsFragment instance = new PrintReportsFragment();        
        return instance;
    }
